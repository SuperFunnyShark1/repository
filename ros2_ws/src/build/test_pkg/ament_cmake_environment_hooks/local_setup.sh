...
: ${AMENT_CURRENT_PREFIX:="/home/superfunnyshark/repository/ros2_ws/src/install/test_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test_pkg/environment/pythonpath.sh"
